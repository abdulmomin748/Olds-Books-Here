        ...
        <div className='py-20'>
            <div className="w-full max-w-md mx-auto p-4 rounded-md shadow sm:p-8 bg-yellow-600  text-white">
                ...
                <div className="my-6 space-y-4">
                    <button aria-label="Login with Google" type="button" className="flex ggle_btn items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 dark:border-gray-400 focus:ring-violet-400">
